/*
 * TraverseHighSpeedIdiomVectorStringBenchmark.java
 *
 * 12.04.2010
 *
 ...
 * high-speed for idiom.
 *
 * @author Michael Lieshoff
 * @version 1.0 12.04.2010
 * @since 1.0
 */
public class TraverseHighSpeedIdiomVectorStringBenchmark extends
        AbstractObjectLoadBenchmark<List<String>> {

    /**
     * creates a new traverse high speed vector string benchmark.
     */
    public TraverseHighSpeedIdiomVectorStringBenchmark() {
        super();
        this.setName("Traverse: For(high speed idiom) Vector<String>");
    }
