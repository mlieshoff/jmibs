/*
 * JFreeChartBarIterationObjectLoadIntervalBenchmarkSuiteResultRenderer.java
 *
 * 16.06.2010
 *
 ...
 * @since 1.1
 */
public class JFreeChartBarIterationObjectLoadIntervalBenchmarkSuiteResultRenderer implements
     ...
     */
    protected JFreeChartBarIterationObjectLoadIntervalBenchmarkSuiteResultRenderer() {
        super();
    }
     ...
     */
    public static JFreeChartBarIterationObjectLoadIntervalBenchmarkSuiteResultRenderer create() {
        return new JFreeChartBarIterationObjectLoadIntervalBenchmarkSuiteResultRenderer();
    }
    ...
    private JFreeChart createChart(String title, CategoryDataset dataset) {
        JFreeChart chart = ChartFactory.createBarChart(title,
                "Benchmark (Iteration/Object Loading/Interval)", "Time in ns", dataset,
