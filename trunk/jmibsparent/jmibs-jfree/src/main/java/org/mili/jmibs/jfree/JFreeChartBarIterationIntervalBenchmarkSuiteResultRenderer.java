/*
 * JFreeChartBarIterationIntervalBenchmarkSuiteResultRenderer.java
 *
 * 16.06.2010
 *
 ...
 * @since 1.1
 */
public class JFreeChartBarIterationIntervalBenchmarkSuiteResultRenderer implements
    ...
    private CategoryDataset createDataset(List<BenchmarkResult> lbr) {
        ...
        for (int i = 0, n = lbr.size(); i < n; i++) {
            ...
            ds.addValue(br.getTotalTimeNanos(), String.valueOf(ic) + "/" + String.valueOf(iv),
                    b.getName());
        }
        return ds;
    }
    ...
    private JFreeChart createChart(String title, CategoryDataset dataset) {
        JFreeChart chart = ChartFactory.createBarChart(title,
                "Benchmark (Iteration/Interval)", "Time in ns", dataset,
