/*
 * DefaultIterationIntervalBenchmarkSuiteResultTest.java
 *
 * 04.06.2010
 *
 ...
 * @since 1.1
 */
public class DefaultIterationIntervalBenchmarkSuiteResultTest {
    ...
    public void testGetAddExecuteResults() {
        ...
        DefaultIterationIntervalBenchmarkSuiteResult<IntegerInterval> diolbsr =
                new DefaultIterationIntervalBenchmarkSuiteResult<IntegerInterval>();
        diolbsr.addExecuteResult(1, new IntegerInterval(1, 10), this.br);
    ...
    public void testGetAddPrepareResults() {
        ...
        DefaultIterationIntervalBenchmarkSuiteResult<IntegerInterval> diolbsr =
                new DefaultIterationIntervalBenchmarkSuiteResult<IntegerInterval>();
        diolbsr.addPrepareResult(1, new IntegerInterval(1, 10), this.br);
    ...
    public void testCreate() {
        DefaultIterationIntervalBenchmarkSuiteResult<IntegerInterval> diolbsr =
                DefaultIterationIntervalBenchmarkSuiteResult.<IntegerInterval>create();
    ...
    public void testGetExecuteResult() {
        ...
        DefaultIterationIntervalBenchmarkSuiteResult<IntegerInterval> diolbsr =
                new DefaultIterationIntervalBenchmarkSuiteResult<IntegerInterval>();
        diolbsr.addExecuteResult(1, new IntegerInterval(1, 10), this.br);
        assertEquals(this.br, diolbsr.getExecuteResult(1, new IntegerInterval(1, 10)).get(0));
    }
    ...
    public void testGetPrepareResult() {
        ...
        DefaultIterationIntervalBenchmarkSuiteResult<IntegerInterval> diolbsr =
                new DefaultIterationIntervalBenchmarkSuiteResult<IntegerInterval>();
        diolbsr.addPrepareResult(1, new IntegerInterval(1, 10), this.br);
        assertEquals(this.br, diolbsr.getPrepareResult(1, new IntegerInterval(1, 10)).get(0));
        diolbsr.addPrepareResult(1, new IntegerInterval(1, 10), this.br);
        assertEquals(this.br, diolbsr.getPrepareResult(1, new IntegerInterval(1, 10)).get(0));
        diolbsr.addPrepareResult(1, new IntegerInterval(1, 10), this.br1);
        assertEquals(this.br1, diolbsr.getPrepareResult(1, new IntegerInterval(1, 10)).get(1));
    }
