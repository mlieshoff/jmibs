/*
 * DefaultIterationObjectLoadIntervalBenchmarkSuiteResultTest.java
 *
 * 04.06.2010
 *
 ...
 * @since 1.1
 */
public class DefaultIterationObjectLoadIntervalBenchmarkSuiteResultTest {
    ...
    public void testGetAddExecuteResults() {
        ...
        DefaultIterationObjectLoadIntervalBenchmarkSuiteResult<IntegerInterval> diolbsr =
                new DefaultIterationObjectLoadIntervalBenchmarkSuiteResult<IntegerInterval>();
        diolbsr.addExecuteResult(1, 1, new IntegerInterval(1, 10), this.br);
    ...
    public void testGetAddPrepareResults() {
        ...
        DefaultIterationObjectLoadIntervalBenchmarkSuiteResult<IntegerInterval> diolbsr =
                new DefaultIterationObjectLoadIntervalBenchmarkSuiteResult<IntegerInterval>();
        diolbsr.addPrepareResult(1, 1, new IntegerInterval(1, 10), this.br);
        assertEquals(this.br, diolbsr.getPrepareResults().get(0));
    }

    @Test
    public void testDefaultIterationObjectLoadIntervalBenchmarkSuiteResult() {
        DefaultIterationObjectLoadIntervalBenchmarkSuiteResult<IntegerInterval> diolbsr =
                new DefaultIterationObjectLoadIntervalBenchmarkSuiteResult<IntegerInterval>();
    ...
    public void testCreate() {
        DefaultIterationObjectLoadIntervalBenchmarkSuiteResult<IntegerInterval> diolbsr =
                DefaultIterationObjectLoadIntervalBenchmarkSuiteResult.<IntegerInterval>
                create();
    ...
    public void testGetExecuteResult() {
        ...
        DefaultIterationObjectLoadIntervalBenchmarkSuiteResult<IntegerInterval> diolbsr =
                new DefaultIterationObjectLoadIntervalBenchmarkSuiteResult<IntegerInterval>();
        diolbsr.addExecuteResult(1, 1, new IntegerInterval(1, 10), this.br);
        assertEquals(this.br, diolbsr.getExecuteResult(1, 1, new IntegerInterval(1, 10))
                .get(0));
    }
    ...
    public void testGetPrepareResult() {
        ...
        DefaultIterationObjectLoadIntervalBenchmarkSuiteResult<IntegerInterval> diolbsr =
                new DefaultIterationObjectLoadIntervalBenchmarkSuiteResult<IntegerInterval>();
        diolbsr.addPrepareResult(1, 1, new IntegerInterval(1, 10), this.br);
        assertEquals(this.br, diolbsr.getPrepareResult(1, 1, new IntegerInterval(1, 10)).get(
                0));
        diolbsr.addPrepareResult(1, 1, new IntegerInterval(1, 10), this.br);
        assertEquals(this.br, diolbsr.getPrepareResult(1, 1, new IntegerInterval(1, 10)).get(
                0));
        diolbsr.addPrepareResult(1, 1, new IntegerInterval(1, 10), this.br1);
        assertEquals(this.br1, diolbsr.getPrepareResult(1, 1, new IntegerInterval(1, 10)).get(
                1));
    }
